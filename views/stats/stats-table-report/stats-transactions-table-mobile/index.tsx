...
const StatsTransactionTableMobile: FC = () => {
  ...
  return (
    <Div
      ...
      borderRadius="0.5rem"
      borderColor="#1F2937"
      borderWidth={noTransactions ? '1px 1px 1px 1px' : '1px 1px 0px 1px'}
      display={['flex', 'flex', 'flex', 'none']}
      py={noTransactions ? ['1.5rem', '1.5rem', '1.5rem', 0] : undefined}
      height={
        noTransactions ? ['11.75rem', '11.75rem', '11.75rem', 0] : undefined
      }
    >
      {noTransactions ? (
        <NoCoin />
